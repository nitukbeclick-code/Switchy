...
List<CommunityPost> get communityPosts => [
  ...
  CommunityPost(id: '12', author: 'ג\'ושוע מוסה', avatar: 'ג', channel: 'חבילה משולבת', text: 'מי יכול להמליץ על חבילה משולבת שכוללת HOT-1 וסלולר? תקציב ₪200', likes: 14, replies: 31, timestamp: DateTime.now().subtract(const Duration(days: 6))),
];
