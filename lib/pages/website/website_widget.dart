            ...
            actions: [
              Container(
                ...
                child: ElevatedButton(
                  ...
                  child: Text('השוו מסלולים', style: GoogleFonts.rubik(fontSize: 12, fontWeight: FontWeight.w700, color: Colors.white)),
                ),
              ),
            ],
          ),
                ...
                children: [
                  ...
                  DecoratedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      child: Text('השוו מסלולים מתאימים', style: GoogleFonts.rubik(fontSize: 16, fontWeight: FontWeight.w800, color: Colors.white)),
                    ),
                  ),
                ],
              ),
