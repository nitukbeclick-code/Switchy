...
var MAX_INFLIGHT = 4;
var MAX_NEED = 100;
var MAX_NEED_CHARS = 18000;
var FAIL_TTL = 3 * 60 * 1000;
var FAIL_TTL_BUDGET = 60 * 60 * 1000;
var CACHE_KEY_CAP = 40;
var SEEN_CAP = 2000;
var DICT_TIMEOUT = 8000;
var staticTried = {};
var controllers = [];
var queuedLang = null;
var committed = false;
var lastDegraded = "";
var sawTranslatable = false;
var sawMeta = false;
var switchSeq = 0;
...
try {
var m = memFor(lang);
mergeInto(m, localStorage.getItem(sharedKey(lang)));
mergeInto(m, localStorage.getItem(pageKey(lang)));
} catch (e) { }
}
...
if (r.status === 404) { staticTried[lang] = 1; clear(); return null; }
...
var ks = cacheKeys(key, true).concat(cacheKeys(key, false).filter(function (k) { return /:__shared$/.test(k); }));
...
if (el.hasAttribute("data-swi18n-" + attr)) continue;
...
return Math.min(400 * Math.pow(2, attempt - 1), 8000);
}
...
if (startGen === switchSeq) liveFetched = true;
...
if (busy) { queuedLang = lang; closeMenu(); return; }
