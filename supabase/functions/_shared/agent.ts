...
- אם escalate_to_human מחזיר ok:false (reason: handoff_unavailable) — אף נציג לא קיבל התראה. אסור להבטיח שנציג יחזור. במקום זה בקש/י שם ומספר טלפון ואישור לתנאים, וקרא/י ל-create_lead כדי שהפנייה תגיע לצוות.
