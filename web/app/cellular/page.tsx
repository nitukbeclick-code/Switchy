// ────────────────────────────────────────────────────────────────────────────
// /cellular — the CELLULAR category landing. The web-app counterpart of the
// static site/cellular.html: a real intro, a FEATURED table of the cheapest
// plans, onward subcategory links, and a clear hand-off to the full
// /compare/cellular hub. Mirrors the static page's content/structure, adapted to
...
export const metadata: Metadata = pageMetadata({
  title: "מסלולי סלולר — השוואת מחירים מכל החברות",
  ...
  description:
    ...
    "כל חבילות הסלולר במקום אחד — 5G, גלישה ללא הגבלה, דקות ו-SMS. השוו מחירים " +
      "מכל החברות, כולל המחיר אחרי המבצע, ומצאו את המסלול שמתאים בדיוק לכם. השוואה חינמית.",
  path: "/cellular",
});

export default async function CellularLandingPage() {
  ...
  const subcats = [
    ...
    { href: "/providers", label: "לפי ספק — כל חברות הסלולר" },
    { href: `/guides#cat-${encodeURIComponent(CATEGORY_HE[CATEGORY])}`, label: "מדריכי סלולר" },
    { href: "/street-prices", label: "מחירי רחוב אמיתיים" },
  ];
  ...
  const related = [
    ...
    },
    {
      ...
      hint: "אינטרנט, טלוויזיה וסלולר בחבילה אחת.",
    },
    ...
    <main id="main" className="mx-auto w-full max-w-5xl flex-1 px-4 py-10 sm:px-6">
      ...
      <JsonLd
        data={collectionPageSchema({
          ...
          description:
            "השוואת מסלולי סלולר מכל החברות בישראל — 5G, גלישה, דקות ו-SMS, כולל המחיר אחרי המבצע.",
          url: `/${CATEGORY}`,
          plans,
        })}
      />
        ...
        <div className="mx-auto max-w-2xl">
          ...
          >
            ...
            <TrackedCtaLink
              ...
              location="category-hero"
              label="consult"
              className="interactive text-sm text-white/85 underline underline-offset-4"
            >
              או דברו עם יועץ
            </TrackedCtaLink>
          </div>
