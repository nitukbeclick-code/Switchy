...
export default function TermsPage() {
  ...
  const sections: Section[] = [
    ...
    },
    {
      h: "זכות ביטול עסקה",
      paras: [
        "שירות ההשוואה והליווי שלנו ניתן ללא תשלום, ואין בינינו לבינכם עסקה " +
          "בתשלום שניתן לבטל. ההתקשרות בפועל (רכישת המסלול) נעשית מול חברת " +
          "התקשורת, וזכויות הביטול חלות על אותה עסקה מול הספק — בהתאם לחוק הגנת " +
          "הצרכן, התשמ״א-1981 ולתקנות הגנת הצרכן (ביטול עסקה), התשע״א-2010.",
        "למידע כללי על זכות הביטול מול הספק: בעסקת מכר מרחוק (טלפונית או " +
          "מקוונת) ניתן בדרך כלל לבטל בתוך 14 ימים ממועד העסקה או מקבלת מסמך " +
          "פרטי העסקה, לפי המאוחר. אדם עם מוגבלות, אזרח ותיק (בן 65 ומעלה) " +
          "ועולה חדש רשאים לבטל עסקה שכללה שיחה בין הצדדים בתוך 4 חודשים. " +
          "בביטול שאינו עקב פגם רשאי הספק לגבות דמי ביטול בשיעור של עד 5% " +
          "ממחיר העסקה או 100 ש״ח — הנמוך מביניהם. בעסקאות תקשורת מתמשכות " +
          "חלים גם כללים ייעודיים לפי הדין ומדיניות הספק; מומלץ לאמת את תנאי " +
          "הביטול ודמי הביטול מול הספק לפני ההתקשרות.",
      ],
    },
    {
